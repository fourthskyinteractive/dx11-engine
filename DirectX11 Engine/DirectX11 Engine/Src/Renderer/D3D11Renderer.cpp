...
CComPtr<ID3D11DepthStencilState>	D3D11Renderer::skyboxDepthStencilState = NULL;
...
// 	backBufferPtr = 0;
	...
	hr = d3dDevice->CreateDepthStencilState(&depthStencilDesc, &skyboxDepthStencilState);
