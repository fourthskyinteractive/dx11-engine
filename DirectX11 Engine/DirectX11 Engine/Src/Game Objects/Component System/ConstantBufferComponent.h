...
enum CONSTANT_BUFFER_COMPONENTS{WORLD_MATRIX_COMPONENT, VIEW_MATRIX_COMPONENT, PROJECTION_MATRIX_COMPONENT, MISCELANEOUS_COMPONENT};
...
public:
	...
	void AddConstantBufferComponent(CONSTANT_BUFFER_COMPONENTS _component, void* _data, unsigned int _size, void* _memoryAddress);
