...
#define FBXSDK_VERSION_NAME		"RC"		//<! String, version name, example: Alpha, Beta, RC, Release
#define FBXSDK_VERSION_YEAR     2013		//<! Integer, release date year
#define FBXSDK_VERSION_MONTH	03			//<! Integer, release date month
#define FBXSDK_VERSION_DAY		05			//<! Integer, release date day
...
//FBX SDK namespace definition
	...
	#define FBXSDK_NAMESPACE fbxsdk_2014_1_rc
#else
